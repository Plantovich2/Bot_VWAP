...
# Usa 3 dca (1,8, 3,4, 5,2) con delays de siguiente vela 
...
def trading_loop():
    ...
    while True:
        try:
            ...
            print(f"{YELLOW}RSI 4H: {rsi_4h:.2f} | 1H: {rsi_1h:.2f} | 30m: {rsi_30m:.2f} | 15m: {rsi_15m:.2f} | 3m: {rsi_3m:.2f}{RESET}")
            ...
            # =========================
                ...
                print(f"{GREEN}LONG | Avg: {avg:.2f} | PnL: {pnl:.2f}% | Size: {sum(e['size'] for e in position['entries'])}{RESET}")
            ...
            # =========================
                ...
                print(f"{RED}SHORT | Avg: {avg:.2f} | PnL: {pnl:.2f}% | Size: {sum(e['size'] for e in position['entries'])}{RESET}")
